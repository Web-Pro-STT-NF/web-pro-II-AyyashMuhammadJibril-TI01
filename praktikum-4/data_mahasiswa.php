...
<body>
    ...
    <div class="row pt-2 px-4">
        ...
        $masis1 = new Mahasiswa("02011", "Faiz Fikri", "TI", 2012, 3.8);
        $masis2 = new Mahasiswa("02012", "Alissa Khairunnisa", "TI", 2012, 3.9);
        $masis3 = new Mahasiswa("01011", "Rosalie Naurah", "SI", 2010, 3.46);
        $masis4 = new Mahasiswa("01012", "Defghi Muhammad", "SI", 2010, 3.2);
